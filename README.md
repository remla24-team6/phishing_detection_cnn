...
![Train Accuracy](https://img.shields.io/badge/train_accuracy--blue)
![Train Loss](https://img.shields.io/badge/train_loss--blue)
![Validation Accuracy](https://img.shields.io/badge/val_accuracy--blue)
![Validation Loss](https://img.shields.io/badge/val_loss--blue)
![Test Accuracy](https://img.shields.io/badge/test_accuracy--blue)
![Average Precision](https://img.shields.io/badge/avg_precision--blue)
![Average Recall](https://img.shields.io/badge/avg_recall--blue)
![Average F1 Score](https://img.shields.io/badge/avg_f1--blue)
![ROC AUC](https://img.shields.io/badge/roc_auc--blue)
